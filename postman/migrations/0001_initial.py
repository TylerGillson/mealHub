    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation_by', models.ForeignKey(related_name='moderated_messages', verbose_name='moderator', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.DO_NOTHING)),
                ('parent', models.ForeignKey(related_name='next_messages', verbose_name='parent message', blank=True, to='postman.Message', null=True, on_delete=models.DO_NOTHING)),
                ('recipient', models.ForeignKey(related_name='received_messages', verbose_name='recipient', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.DO_NOTHING)),
                ('sender', models.ForeignKey(related_name='sent_messages', verbose_name='sender', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.DO_NOTHING)),
                ('thread', models.ForeignKey(related_name='child_messages', verbose_name='root message', blank=True, to='postman.Message', null=True, on_delete=models.DO_NOTHING)),
            ],
            options={
                'ordering': ['-sent_at', '-id'],
